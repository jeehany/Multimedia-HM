...
<form method="get" class="row g-2 auto-filter">
  ...
  <div class="col-md-3"><input type="month" name="bulan" class="form-control" value="<?=htmlspecialchars($_GET['bulan'] ?? '')?>"></div>
  ...
  <div class="col-md-2 align-self-end"><a class="btn btn-success" href="pengeluaran_add.php"><i class="fa fa-plus"></i> Tambah</a></div>
</form>
</div></div>
<?php else: ?>
