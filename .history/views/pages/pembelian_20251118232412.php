...
<div class="card mb-3"><div class="card-body">
  <form method="get" class="row g-2 auto-filter">
    ...
    <div class="col-md-"><input type="date" name="tgl_awal" class="form-control" value="<?=htmlspecialchars($_GET['tgl_awal'] ?? '')?>" title="Tanggal Awal" aria-label="Tanggal Awal" data-bs-toggle="tooltip" data-bs-title="Dari"></div>
