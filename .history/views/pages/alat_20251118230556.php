...
<div class="card mb-3">
  <div class="card-body">
    <form method="get" id="alat-filter-form" class="row g-2 auto-filter">
      ...
      <div class="col-md-2"><input type="text" name="lokasi" value="<?=htmlspecialchars($_GET['lokasi'] ?? '')?>" class="form-control" placeholder="Lokasi"></div>
      <div class="col-md-2 align-self-end"><?php if(can_edit()): ?><a class="btn btn-success" href="alat_add.php"><i class="fa fa-plus"></i> Tambah</a><?php endif; ?></div>
    </form>
  </div>
</div>
