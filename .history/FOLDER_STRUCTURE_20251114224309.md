...
```html
Dashboard → href="/index.php" Data Alat → href="/views/pages/alat.php"
Maintenance → href="/views/pages/maintenance.php" Permohonan Pembelian →
href="/views/pages/pembelian.php" Pengeluaran →
href="/views/pages/pengeluaran.php" Manajemen Konten →
href="/views/pages/konten.php" Laporan → href="/reports/laporan.php"
```
