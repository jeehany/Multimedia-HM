...
<div class="card mb-3">
  <div class="card-body">
    <form method="get" class="row g-2">
      ...
      <div class="col-md-2"><select name="kondisi" class="form-select"><option value="">--Kondisi--</option><option value="baik" <?=(!empty(
          									$_GET['kondisi']) && $_GET['kondisi']=='baik')?'selected':''?>>baik</option><option value="rusak ringan" <?=(!empty($_GET['kondisi']) && $_GET['kondisi']=='rusak ringan')?'selected':''?>>rusak ringan</option><option value="rusak berat" <?=(!empty($_GET['kondisi']) && $_GET['kondisi']=='rusak berat')?'selected':''?>>rusak berat</option></select></div>
